export const PORTFOLIO = {
  personal: {
    ...
    heroHeadline: 'I build systems that scale.',
    heroSubheadline: 'Software Engineer. AI Systems Builder. Startup Founder in progress.',
    tagline: 'Designing intelligent systems, scalable architectures, and AI-driven products — built to create real-world impact.',
    bio: `I engineer systems at the intersection of AI and real-world business problems. With a BSc in Software Engineering from Haramaya University and 2+ years of hands-on experience building AI-powered products and ERP automation, I focus on one thing: building software that actually works at scale.`,
    email: 'tedrosmilion19@gmail.com',
    location: 'Addis Ababa, Ethiopia',
    profilePhoto: '/tewodros-profile.jpg',
  },
    ...
    philosophy: [
      {
        ...
        description: 'I think in systems, not just features. Every product I build is designed to scale — from 10 users to 10 million.',
        icon: 'layers',
      },
      {
        title: 'AI as Infrastructure',
        description: 'AI is not a feature — it is the foundation. I integrate intelligence into the core of every system I design.',
        icon: 'cpu',
      },
      {
        title: 'Real-World Impact First',
        description: 'I build for Ethiopia and beyond. Every line of code is written with the question: does this solve a real problem for real people?',
        icon: 'globe',
      },
      {
        title: 'Ship, Learn, Iterate',
        description: 'Speed matters. I ship fast, measure impact, and iterate relentlessly. Perfection is the enemy of progress.',
        icon: 'zap',
      },
    ],
  },
  ...
  vision: {
    ...
    directions: [
      ...
      {
        title: 'AI-Native ERP for SMEs',
        description: 'Building lightweight, AI-powered business management tools for small and medium enterprises in emerging markets.',
        status: 'In Progress',
      },
      {
        title: 'Developer Tools for Africa',
        description: 'Creating infrastructure and tooling that makes it easier for African engineers to build, deploy, and scale products globally.',
        status: 'Vision',
      },
    ],
  },
  ...
  experience: [
    {
      ...
      highlights: [
        ...
        'Built and deployed custom Odoo ERP modules serving enterprise clients',
        'Designed scalable backend APIs handling complex business logic',
        'Led technical requirement analysis and solution architecture for client projects',
      ],
    },
    {
      ...
      highlights: [
        ...
        'Developed strategic frameworks improving match quality and relevance',
        'Authored technical PR and thought-leadership content for platform positioning',
        'Collaborated remotely with cross-functional teams on data strategy',
      ],
    },
  ],
  ...
  certifications: [
    {
      ...
      description: 'Validates expertise in Oracle Cloud AI services including machine learning, natural language processing, vision AI, and generative AI. Covers OCI AI infrastructure, model deployment, and enterprise AI integration patterns.',
    },
    {
      id: 'ibm-cloud-intro',
      ...
      description: 'Covers core cloud computing concepts including IaaS, PaaS, SaaS, hybrid and multi-cloud architectures, cloud security, and emerging technologies. Issued via IBM on Coursera as part of the Full Stack Developer path.',
    },
    {
      ...
      description: 'Demonstrates proficiency in designing, building, and deploying AI agents using Oracle Fusion AI Agent Studio. Covers agent orchestration, tool integration, prompt design, and enterprise workflow automation.',
    },
    {
      id: 'google-ux-design',
      ...
      description: 'A 7-course professional certificate covering the full UX design process — user research, wireframing, prototyping, usability testing, and Figma. Issued by Google via Coursera.',
    },
    {
  ...
  skills: {
    ...
    'Data Science': ['Jupyter Notebook', 'Pandas', 'NumPy', 'Matplotlib', 'Scikit-learn'],
    'Frameworks & Libraries': ['React.js', 'Next.js', 'Node.js', 'Express.js', 'Odoo Framework'],
    'Databases': ['PostgreSQL', 'MongoDB', 'Supabase'],
    'ERP & DevTools': ['Odoo ERP', 'Git', 'Docker', 'REST APIs', 'Postman'],
