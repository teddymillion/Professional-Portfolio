...
export function Certifications() {
  ...
  return (
    <section id="certifications" ref={ref} className="py-16 px-4 md:px-6">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-blue-900 hover:bg-white-500/20 transition-colors hover:text-blue-500 ">Certifications</h2>
