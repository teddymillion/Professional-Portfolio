...
export function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-20 px-4 md:px-6">
      <motion.div className="max-w-2xl mx-auto" variants={containerVariants} initial="hidden" animate={inView ? 'visible' : 'hidden'}>
        <motion.div variants={itemVariants} className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Let's <span className="text-accent">Connect</span>
          </h2>
          <div className="w-12 h-1 bg-accent rounded-full mx-auto mb-6" />
          <p className="text-lg text-muted-foreground">Have a project in mind or just want to chat? Feel free to reach out!</p>
        </motion.div>
